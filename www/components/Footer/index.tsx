...
const Footer = (props: Props) => {
  ...
  return (
    <footer
      className="bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-600"
    ...
    >
      ...
      <SectionContainer>
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <div className="flex space-x-6">
              ...
              <a
                href="https://github.com/fonoster"
                className="text-gray-300 hover:text-gray-400"
              >
              ...
              {FooterLinks.map((segment: any) => {
                return (
                  <div key={`footer_${segment.title}`}>
                    <h3 className="text-sm text-gray-300 dark:text-dark-400 uppercase font-bold">
                      {segment.title}
                    </h3>
        ...
        <div className="mt-32 border-t dark:border-dark pt-8 flex justify-center">
          <p className="text-base text-gray-400 dark:text-dark-300">
            &copy; {new Date().getFullYear()}, Fonoster. All Rights Reserved.
          </p>
